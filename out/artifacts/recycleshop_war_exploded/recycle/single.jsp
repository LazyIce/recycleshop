        ...
        <div class="head-top">
            <div class=" h_menu4">
                <ul class="memenu skyblue">
                    ...
                    <li class="active grid"><a class="color1" href="#">回收种类</a>
                        <div class="mepanel">
                            <div class="row">
                                <div class="col1">
                                    <div class="h_nav">
        ...
        <div class="col-md-9 product-price1">
            <div class="col-md-5 single-top">
                <div class="flexslider">
                    <ul class="slides">
                        <li data-thumb="../images/battery.jpg">
            ...
            <div class="col-md-7 single-top-in simpleCart_shelfItem">
                <form  method="post" action="/RecycleServlet?act=addOrder&username=<%= username %>">
                    <div class="single-para ">
                        ...
                        <h5 class="item_price">10积分/per</h5>
                        <p>请在下方选择要发布的电池的数量及种类，种类若不明确，请参考左图  </p>
                        <div class="available">
                            <ul>
                                <li>数量
                        ...
                        <ul class="tag-men">
                            <li><span>标签</span>
                                <span class="women1">: 电池  回收</span></li>
                        </ul>
